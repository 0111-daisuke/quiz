...
def generate_story():
    ...
    story_create_messages = [
        {"role": "system",
         "content": f"""
         下記の条件をもとに以下のことわざをテーマにしたショートストーリーを生成してください。
         ことわざ:{answer}
         【条件】
         1.物語の中に与えたことわざを含める
         2.200字～300字に収める
         3.起承転結をまとめる
         以下は生成例です。これを参考にして物語を考えてください。
         -------------------------------
         【例】
         ことわざ: 三人寄れば文殊の知恵
         ある日、太郎さんと花子さんは町内会の催しで使うアイデアを考えていました。ところが、どうしても良い案が思い浮かばず、困り果てていました。「どうしようか？」と太郎さんが悩むと、花子さんも「一人では限界があるわね」とうなずきます。そこで、二人は隣に住むおばあさんを訪ねました。おばあさんは長年の経験から、「昔、竹で作った灯籠が人気だったわ」と教えてくれました。その言葉を聞いた二人はアイデアを膨らませ、竹灯籠を町の人々と一緒に作ることにしました。結果、催しは大成功。「三人寄れば文殊の知恵」と、太郎さんと花子さんは感謝し、おばあさんと笑い合いました。
         -------------------------------
         """}
        ]
